...
<div class="left" id="LeftBox">
	...
	<div class="left02">
		<div class="left02top">
			...
			<div class="left02top_left"></div>
			<div class="left02top_c">
                <asp:Button ID="btnCommunityManage" runat="server" Text="社区信息管理" Width="118px" BackColor="White" BorderColor="White" BorderStyle="None" OnClick="btnCommunityManage_Click"  />
            </div>
		</div>
	</div>
    <div class="left02">
